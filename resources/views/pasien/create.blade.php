<x-app-layout>
            ...
            <div class="mb-8">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_kk" maxlength="16" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" value="{{ old('no_kk') }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_kepala_keluarga" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" value="{{ old('nama_kepala_keluarga') }}">
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="id_kelompok_gp" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white">
                            ...
                            @foreach($kelompokGps as $gp)
                                <option value="{{ $gp->id_kelompok_gp }}" {{ old('id_kelompok_gp') == $gp->id_kelompok_gp ? 'selected' : '' }}>{{ $gp->nama_kelompok_gp }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const oldKalurahan = '{{ old("id_kelurahan") }}';
            
            const dukuhSelect = document.getElementById('id_dukuh');
            const oldDukuh = '{{ old("id_dukuh") }}';
                        ...
                        fetch(`/puskesmas/${id}/kelurahans`)
                            ...
                            .then(data => {
                                ...
                                data.forEach(kel => {
                                    ...
                                    if (oldKalurahan === kel.id_kelurahan) option.selected = true;
