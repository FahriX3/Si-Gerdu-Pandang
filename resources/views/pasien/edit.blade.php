<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Ubah data demografi dan riwayat kesehatan pasien.</p>
        </div>
    </x-slot>
            ...
            <div class="mb-8">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="id_puskesmas" id="id_puskesmas" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" required>
                            ...
                            @foreach($puskesmas as $p)
                                <option value="{{ $p->id_puskesmas }}" {{ old('id_puskesmas', $pasien->id_puskesmas) == $p->id_puskesmas ? 'selected' : '' }}>{{ $p->nama_puskesmas }}</option>
                            @endforeach
                        </select>
                    </div>
                    @endif
                    <div>
                        ...
                        <input type="text" name="nik" maxlength="16" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" required value="{{ old('nik', $pasien->nik) }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_rm" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" value="{{ old('no_rm', $pasien->no_rm) }}">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" required value="{{ old('tanggal_lahir', $pasien->tanggal_lahir ? $pasien->tanggal_lahir->format('Y-m-d') : '') }}">
                    </div>
                    <div>
            ...
            <div class="mb-8">
                ...
                <div class="grid gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="rt" maxlength="5" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" value="{{ old('rt', $pasien->rt) }}">
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-semibold text-slate-700 dark:text-slate-300">RW</label>
                        <input type="text" name="rw" maxlength="5" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" value="{{ old('rw', $pasien->rw) }}">
                    </div>
                    <div class="sm:col-span-3">
                        <label class="block mb-2 text-sm font-semibold text-slate-700 dark:text-slate-300">Nomor HP Aktif</label>
                        <input type="text" name="no_hp" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full md:w-1/2 p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" value="{{ old('no_hp', $pasien->no_hp) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_jkn" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white" value="{{ old('no_jkn', $pasien->no_jkn) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="status_peserta_prb" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-primary-500 focus:border-primary-500 block w-full p-3 shadow-sm dark:bg-slate-900 dark:border-slate-700 dark:text-white">
                            ...
                            <option value="HT" {{ old('status_peserta_prb', $pasien->status_peserta_prb) == 'HT' ? 'selected' : '' }}>HT</option>
                            <option value="DM" {{ old('status_peserta_prb', $pasien->status_peserta_prb) == 'DM' ? 'selected' : '' }}>DM</option>
                            <option value="Penyakit Jantung" {{ old('status_peserta_prb', $pasien->status_peserta_prb) == 'Penyakit Jantung' ? 'selected' : '' }}>Penyakit Jantung</option>
                            <option value="PPOK" {{ old('status_peserta_prb', $pasien->status_peserta_prb) == 'PPOK' ? 'selected' : '' }}>PPOK</option>
                            <option value="Asma" {{ old('status_peserta_prb', $pasien->status_peserta_prb) == 'Asma' ? 'selected' : '' }}>Asma</option>
                        </select>
                    </div>
                </div>
            </div>
